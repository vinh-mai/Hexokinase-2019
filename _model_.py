...
def MODEL(y, t, k0, k1, k_1, k2, k_2, k3, k_3, k4, k_4, \
...
k5, k_5, k6, k_6, k7, k_7, k8, k_8, k9, k_9):
	...
	#
	#15 Eq. for _01E_
    dydt.append(k0*_01E01_ + k_2*_01E0_ + k_4*_01E1_ + k_6*_01E2_ \
    
    		+ k_8*_01E3_ + _0_*_1E_*k1 + _1_*k3*_0E_ \

		- _01E_*(k_1 + k_3 + k2*_0_ + k4*_1_ + k6*_2_ + k8*_3_))

	#16 Eq. for _02E_
    dydt.append(k0*_02E01_ + k_2*_02E0_ + k_4*_02E1_ + k_8*_02E3_ \
    
    		+ k1*_0_*_2E_ + _2_*k5*_0E_ \
    ...
    #21 Eq. for _0E3_
    dydt.append(k_2*_0E03_ + k_3*_01E3_ + k_5*_02E3_ + k_7*_03E3_ \
    
    		+ k1*_0_*_E3_ + _3_*k8*_0E_ \
	...
	#24 Eq. for _1E2_
    dydt.append(k_1*_01E2_ + k_2*_1E02_ + _1_*k3*_E2_ + _2_*k6*_1E_ \
	...
	#31 Eq. for _3E2_
    dydt.append(k_1*_03E2_ + k_2*_3E02_ + _2_*k9*_3E_ + _3_*k7*_E2_ \
...
# Pi = 6.0 should be changed to 8.0
y0 = []

for y in Pi:
    y0.append([E, G, ATP, G6P, y, ADP,\
...
# Ki = 0.71 mM (N)
k5, k_5 = c*k3, 0.71*k3*c

# Ki = 54 microM = 0.054 mM(C)
k6, k_6 = c*k3, 0.054*k3*c
...
#==Simplified model==#
z = 0.0
p0s =(k0, z*k1, z*k_1, k2, k_2, z*k3, z*k_3, k4, k_4, \
	  k5, k_5, k6, k_6, k7, k_7, k8, k_8, k9, k_9)
...
for i in xl:
    p0l.append((k0, k1, k_1, k2, k_2, k3, k_3, k4, k_4, \
			 k5, k_5, k6, k_6, k7, k_7, k8, k_8, k9, i*k_9))
